...
class SocialAppUtil(AppUtilBase):
    ...
    async def get_social_token(self, code: str, redirect_uri: str, provider_type: ProviderTypeEnum) -> tuple[str, str]:
    ...
    async def get_social_info(self, token: str, provider_type: ProviderTypeEnum) -> SocialInfo:
        if provider_type == ProviderTypeEnum.Spotify:
